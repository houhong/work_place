...
public class Homework {
	...
	public static HashSet<String> getBall(){
		...
		while(dounbleBalls.size()<=6){

			dounbleBalls.add(redPool.get(ranndom()[0]));

			if(dounbleBalls.size()==6){
				dounbleBalls.add(bluePool.get(ranndom()[1]));
			}
...
class employee{
	...
	public employee(int num, String inputOder, String[] doubleBall) {
		super();
		this.num = num;
		this.inputOder = inputOder;
